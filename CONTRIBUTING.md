...
- Codex reviews are optional, manual, and paid. Do not request one unless a
  maintainer explicitly authorizes it for the PR. A missing or incomplete
  `codex-review` status does not block merge; required checks and unresolved
  review conversations still do.
