...
The repository's original work is licensed under the [GNU General Public License v3.0 only](LICENSE). Imported or generated protocol material must pass the provenance rules in [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md) before it is committed.
