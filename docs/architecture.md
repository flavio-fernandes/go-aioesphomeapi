...
The initial customer is MGMT. That priority affects lifecycle, concurrency, observability, cancellation, and Go-version choices; it does not place MGMT types or GPL-licensed MGMT code in this MIT repository.
