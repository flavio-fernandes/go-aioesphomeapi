...
func Lookup(ctx context.Context, host string, timeout time.Duration) (net.IP, error) {
	...
	for {
		...
		if err != nil {
			...
			return nil, errors.New("mDNS lookup timed out")
		}
